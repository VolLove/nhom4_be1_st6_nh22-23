...
-- Thời gian đã tạo: Th12 23, 2022 lúc 11:35 AM
...
INSERT INTO `login` (`id`, `username`, `password`, `fullname`, `address`) VALUES
...
INSERT INTO `manufactures` (`manu_id`, `manu_name`, `logo`) VALUES
(1, 'Samsung', 'Samsung.png'),
(2, 'Realme', 'Realme.png'),
(3, 'MacBook', 'MacBook.png'),
(4, 'SONY', 'SONY.png'),
(5, 'Asus', 'Asus.png'),
(6, 'Apple', 'Apple.png');
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `image` varchar(150) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'image',
...
(5, 'Man hinh', 'product04.png'),
(4, 'Tai nghe', 'shop4.png'),
(3, 'Loa', 'shop3.png'),
(2, 'Laptop', 'shop2.png'),
(1, 'Dien thoai', 'product07.png');
